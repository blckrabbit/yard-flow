export function getShapeName(clazz) {
  switch (clazz) {
    ...
    case 'setTask': return 'set-task-node';
    case 'levelTask': return 'level-task-node';
    case 'otherTask': return 'other-task-node';
    case 'groupTask': return 'group-task-node';
    case 'filterTask': return 'filter-task-node';
    case 'joinTask': return 'join-task-node';
    case 'fullTask': return 'full-task-node';
