export default {
  ...
  edgeActivedStyle: { stroke: '#7cbdf9', strokeOpacity: .92 },
  nodeActivedStyle: { fill: '#F3F9FF', stroke: '#1890FF' },
  groupActivedStyle: { stroke: '#1890FF' },
  edgeSelectedStyle: { lineWidth: 2, strokeOpacity: .92, stroke: '#7cbdf9' },
  ...
  edgeStyle: { stroke: '#085faf', strokeOpacity: .92, lineWidth: 1.5, lineAppendWidth: 8, endArrow: true},
  ...
  anchorHotsoptStyle: { r: 32, fill: 'transparent', stroke: 'transparent',fillOpacity: .25 },/***连接点 */
  anchorHotsoptActivedStyle: { r: 32 },
